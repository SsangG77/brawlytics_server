...
router.get('/', validatePlayerTag, async(req, res) => {
    ...
    try {
        ...
        // JSON 브롤러 배열을 기준으로 비교 (하이퍼차지/버피는 API에서 직접 제공)
